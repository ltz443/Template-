...
```
    ...
    <Card style={{ overflow: 'hidden' }}>
      ...
      {/* Header image ou dégradé — FLUSH, pas de background parasite */}
      <div style={{
        ...
        {o.imageFond ? (
          <>
            {/* Image en display:block pour éviter le liseré Safari */}
            <img
              src={o.imageFond}
              alt={o.nom}
              style={{
          ...
          /* Pas d'image : fond dégradé couleur du véhicule */
          <div style={{
        ...
        {/* Titre + badge — toujours en absolute sur l'image */}
        <div style={{
      ...
      {filtrees.map(o => (
        <button
          ...
          style={{
            ...
            position: 'relative',
            overflow: 'hidden',
            // Pas de outline, pas de background supplémentaire
          }}
        >
          {/* ── Barre couleur flush en haut — z-index au-dessus de l'image ── */}
          <div style={{
            position: 'absolute', top: 0, left: 0, right: 0, height: 3,
            background: o.couleur, zIndex: 10,
            // Pas de borderRadius ici pour rester parfaitement flush
          }} />

          {/* ── Zone image — display:block, pas de background, margin:0 ── */}
          <div style={{
            height: 110,
            overflow: 'hidden',
            lineHeight: 0,       // supprime l'espace fantôme sous l'img inline
            fontSize: 0,         // idem pour Safari
          }}>
            {o.image ? (
              <img
                src={o.image}
                alt={o.nom}
                style={{
                  display: 'block',  // élimine le gap inline Safari
                  width: '100%',
                  height: '100%',
                  objectFit: 'cover',
                  margin: 0,
