...
/* Fullscreen + suppression du fond blanc */
html, body {
  margin: 0;
  padding: 0;
  background: #0A021E; /* Fond sombre neutre derrière ton gradient */
  min-height: 100%;
...
::-webkit-scrollbar-thumb { background: #4C1D95; border-radius: 99px; }
